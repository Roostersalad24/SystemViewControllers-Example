...
//  SystemViewControllers23
//
//  Created by Andrew Johnson on 12/2/23.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func emailButtonTapped(_ sender: UIButton) {
        guard MFMailComposeViewController.canSendMail() else { print("Cannot send mail")
            return
        }
        ...
        mailComposer.setMessageBody("Hello, this is an email from my app", isHTML: false)
